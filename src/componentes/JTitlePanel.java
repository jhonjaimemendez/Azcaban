...
public class JTitlePanel extends JPanel {
    ...
    public JTitlePanel(String title, Icon icon, JComponent content, Border outerBorder) {
        ...
        System.out.println(titlePanel.getBounds());
     ...
     * @param outerBorder the outer border
     */
    public JTitlePanel(String title, Icon icon, JComponent content, Border outerBorder,int anchoTitulo) {
        
        setLayout(null);
       

        label = new JLabel(title, icon, JLabel.LEFT);
        label.setBounds(10,3,anchoTitulo,16);
        label.setForeground(Color.WHITE);

        GradientPanel titlePanel = new GradientPanel(Color.BLACK);
        titlePanel.setBounds(4,5,anchoTitulo  - 8,25);

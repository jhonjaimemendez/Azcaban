 ...
 */
 ...
 /**
  * Esta clase permite convertir un numero en su representación en letras
  */



final public class ConvertirNumeroALetras {
	...
	public ConvertirNumeroALetras (long n ) {
	...
	private String unidad(long numero){
		...
		Long numeroPivote = numero;
		
		switch (numeroPivote.intValue()){
		case 9:
				num = "nueve";
				break;
		case 8:

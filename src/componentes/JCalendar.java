...
public class JCalendar extends JPanel implements PropertyChangeListener {
	...
	public JFormattedTextField jTextFormattedField;
	 ...
	 */
	public JCalendar(JFormattedTextField jTextFormattedField,JButton jButton) {
		
		this(null, null, true, true);
		
		this.jTextFormattedField = jTextFormattedField;

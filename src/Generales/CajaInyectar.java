...
final public class CajaInyectar extends JDialog implements ActionListener, FocusListener {
  ...
  //** Referencia a la Base De Datos
    ...
    //** Constructor General 
    public CajaInyectar(MenuPrincipal p_menuPrincipal, ConectarMySQL conectarMySQL,Long totalCaja,String nombreUsuario,Caja caja) {
      
       super(p_menuPrincipal.crearJFrameParaMenu.getJFrame(),"Inyectar Capital",true);
    ...
    public CajaInyectar(JFrame jFrame, ConectarMySQL conectarMySQL,Long totalCaja,String nombreUsuario) {
      
       super(jFrame,"Inyectar Capital",true);

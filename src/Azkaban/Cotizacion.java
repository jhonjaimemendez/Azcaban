...
final public class Cotizacion extends CrearJFrame implements ActionListener, ListSelectionListener {
    ...
    private  JButton jbEditarProveedor;
   ...
   //** NumberFormat
    ...
    //** Constructor General 
    public Cotizacion(ConectarMySQL p_conectarMySQL,JFrame p_frame,String nombreUsuario) {

      super("Cotizaciones","Toolbar",p_frame);
      ...
      JLabel jlNumeroCompra1 = getJLabel("Cotización Nro:",5, 20, 85, 15);
     ...
     //** Se configura un scroll para el JTable 
      ...
      jtNumeroFactura.setText(buscarNumeroCotizacion());
      ...
      jbEditarProveedor = getJButton("...",440, 30, 20, 20,"","");
      jbEditarProveedor.setFocusable(false);
      jbEditarProveedor.addActionListener(this);
      jpClientes.add(jbEditarProveedor);
     ...
     //******************************** Metodo crearArrayCamposObligatorios *******************
      ...
      public void imprimirFactura() { 
         ...
         parametros.put("Efectivo", "0" );
         parametros.put("Tarjetas","0");
         parametros.put("Bonos","0");
         parametros.put("Total",jtTotal.getText());
         parametros.put("Cambio","0");
         
       
         ImprimirReporteJasper.runReport("Azkaban",conectarMySQL.getConexion(),parametros,"/Reportes/FacturaVenta.jrxml");
   ...
   //******************************** Metodo getComponentesRetorno1()  ***************************************
    ...
    //*****************************Metodo buscarNumeroCotizacion() **************************************
    
    private String buscarNumeroCotizacion() { 

        final String  sentenciaSQL = "Select IfNull(max(NumeroCotizacion),0) "+
    ...
    private void guardar() throws Exception { 
        ...
        guardar("CotizacionesEncabezado",datos,conectarMySQL,false); 
        ...
        guardar("CotizacionesDetalle",datosDetalles,conectarMySQL,6,false);
                  ...
                  if (validarRegistro(camposObligatorios)) {
                  	...
                  	if (obtenerFilas(tablaVentas,9) > 0) {
                  		      ...
                  		      try {
		                          ...
		                          Mensaje("Cotización registrada correctamente","Información",1);

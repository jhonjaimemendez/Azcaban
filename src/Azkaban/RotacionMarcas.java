...
final public class RotacionMarcas extends CrearJFrame implements ActionListener, FocusListener {
   ...
   //Columnas y filas estaticas 
    private Object [] nombresColumnas = {"Código","Marca","Cantidad","Total"};
    ...
    //** Constructor General 
    public RotacionMarcas(ConectarMySQL p_conectarMySQL,JFrame p_frame) {

      super("Rotación de Marcas","Toolbar",p_frame);
      ...
      jpVentas = getJPanel("Marcas",60, 130, 700, 380,14);
  ...
  //*****************************Metodo traerInformacion() ******************************************
    ...
    final private boolean traerInformacion() { 
        ...
        if (jcPeriodos.getSelectedIndex() == 0)
            ...
            sentenciaSQL    =   "Select  M.IdMarca, M.Marca,Sum(V1.Cantidad),Sum(V1.subtotal) "+
                                "From  VentasEncabezado V,VentasDetalle V1, Productos P,Marcas M "+ 
          ...
          if (jcPeriodos.getSelectedIndex() == 1)
	           ...
	           sentenciaSQL    =   "Select   M.IdMarca, M.Marca,Sum(V1.Cantidad),Sum(V1.subtotal) "+
	                                "From  VentasEncabezado V,VentasDetalle V1, Productos P,Marcas M "+ 
	                                "Where V.NumeroVenta = V1.NumeroVenta and V.estado ='G' and V1.IdProducto = P.IdProducto "+
	                                "      and P.IdMarca = M.IdMarca and Substr(V.Fecha,1,10) = '" + getObtenerFecha(conectarMySQL) + "' "+
	                                "Group by M.IdMarca, M.Marca "+
	                                "Order by 3 "+ orden +
	                                "Limit " + numeroRegistro ; 
		          ...
		          if (jcPeriodos.getSelectedIndex() == 2) {
		              ...
		              String condicion = ""; 
			           ...
			           sentenciaSQL    =    "Select  M.IdMarca, M.Marca,Sum(V1.Cantidad),Sum(V1.subtotal) "+
			                                "From  VentasEncabezado V,VentasDetalle V1, Productos P,Marcas M "+ 
			                                "Where V.NumeroVenta = V1.NumeroVenta and V.estado ='G' and V1.IdProducto = P.IdProducto "+
			                                "      and P.IdMarca = M.IdMarca and substr(V.Fecha,1,7) = '" + getObtenerFecha(conectarMySQL).substring(0,7) + "' " +
			          ...
			          if (jcPeriodos.getSelectedIndex() == 3) 
				          ...
				          if (jcPeriodos.getSelectedIndex() == 4) {
					           ...
					           sentenciaSQL    =    "Select  M.IdMarca, M.Marca,Sum(V1.Cantidad),Sum(V1.subtotal) "+
					                                "From  VentasEncabezado V,VentasDetalle V1, Productos P,Marcas M "+ 
					                                "Where V.NumeroVenta = V1.NumeroVenta and V.estado ='G' and V1.IdProducto = P.IdProducto "+
					                                "      and P.IdMarca = M.IdMarca   and substr(V.Fecha,1,7) between " + condicion +
													" Group by M.IdMarca, M.Marca "+
					                                "Order by 3 "+ orden +
					                                "Limit " + numeroRegistro ;                        

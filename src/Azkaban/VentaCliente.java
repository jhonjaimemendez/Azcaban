...
final public class VentaCliente extends CrearJFrame implements ActionListener, FocusListener {
    ...
    private  JTable tablaVentasClientes;
    ...
    private Object [] nombresColumnas =  {"Tipo ","Identificación","Nombres","Numero De Ventas","Fecha","Total"};
    ...
    //** Constructor General 
    public VentaCliente(ConectarMySQL p_conectarMySQL,JFrame p_frame) {

      super("Ventas Por Cliente","Toolbar",p_frame);
      ...
      jpVentas = getJPanel("Ventas Realizadas",40, 60, 700, 395,14);
      	...
      	public void stateChanged(ChangeEvent a) {
      		...
      		if (pestaña.getSelectedIndex() == 1) {
               ...
               jtTotalPagado.setText("");
                ...
                tablaVentasClientes.getColumnModel().getColumn(0).setPreferredWidth(75);
	            tablaVentasClientes.getColumnModel().getColumn(0).setMinWidth(15);
	            tablaVentasClientes.getColumnModel().getColumn(0).setMaxWidth(2147483647);
	        
	            tablaVentasClientes.getColumnModel().getColumn(1).setPreferredWidth(75);
	            tablaVentasClientes.getColumnModel().getColumn(1).setMinWidth(15);
	            tablaVentasClientes.getColumnModel().getColumn(1).setMaxWidth(2147483647);
	        
	            tablaVentasClientes.getColumnModel().getColumn(2).setPreferredWidth(75);
	            tablaVentasClientes.getColumnModel().getColumn(2).setMinWidth(15);
	            tablaVentasClientes.getColumnModel().getColumn(2).setMaxWidth(2147483647);
	         
		        
		        ocultarColumnas(tablaVentasClientes,4);
              ...
              tablaVentasClientes.getColumnModel().getColumn(4).setPreferredWidth(75);
		      tablaVentasClientes.getColumnModel().getColumn(4).setMinWidth(15);
		      tablaVentasClientes.getColumnModel().getColumn(4).setMaxWidth(2147483647);
		        
		        
              ocultarColumnas(tablaVentasClientes,0);
              ocultarColumnas(tablaVentasClientes,1);
              ocultarColumnas(tablaVentasClientes,2);
     ...
     tablaVentasClientes = getJTable(dm); //Se instancia el JTable con el modelo de datos
     tablaVentasClientes.addFocusListener(this);
     tablaVentasClientes.addMouseListener(new MouseAdapter() {
     ...
     //** Se configura un scroll para el JTable 
      ...
      JScrollPane scrollPane = new JScrollPane(tablaVentasClientes);
	...
	private void configurarColumnas() {
		...
		tablaVentasClientes.getColumnModel().getColumn(0).setPreferredWidth(5);
	    tablaVentasClientes.getColumnModel().getColumn(1).setPreferredWidth(60);
		tablaVentasClientes.getColumnModel().getColumn(1).setCellRenderer(getAlinearCentro());
		tablaVentasClientes.getColumnModel().getColumn(2).setPreferredWidth(210);
		tablaVentasClientes.getColumnModel().getColumn(2).setCellRenderer(getAlinearIzquierda());
		tablaVentasClientes.getColumnModel().getColumn(3).setPreferredWidth(80);
		tablaVentasClientes.getColumnModel().getColumn(4).setCellRenderer(getAlinearCentro());
	    tablaVentasClientes.getColumnModel().getColumn(5).setCellRenderer(getAlinearDerecha());
	
	
	    if (pestaña.getSelectedIndex() == 1)
	    
	       	tablaVentasClientes.getColumnModel().getColumn(3).setCellRenderer(getAlinearCentro());
	    
	    else   	
	       
	       tablaVentasClientes.getColumnModel().getColumn(3).setCellRenderer(getAlinearDerecha());
	...
	final private Object[][] getComponentesRetorno() {
        ...
        objetosRetorno[0][1] = tablaVentasClientes; 
  ...
  //*****************************Metodo traerInformacion() ******************************************
        ...
        String sentenciaSQL = "";
            ...
            if (pestaña.getSelectedIndex() == 1) 
                ...
                sentenciaSQL    =   "Select  Case V.TipoId WHEN 'C' THEN 'Cedula'"+ 
				                    "                   WHEN 'T' THEN 'Tarjeta Id.'"+
				                    "                   Else 'Pasaporte'"+
				                    "                   End,V.idCliente, Concat(C.Nombre,Concat(' ',C.Apellido)),count(1),sum(total),Sum(ifnull((Select D.Total " +
    ...
    //********************* configurarJDialogVentasDetalle()****************************************
      ...
      private void configurarJDialogVentasDetalle() {
	    ...
	    traerInformacionDetalle(tablaVentasClientes.getValueAt(tablaVentasClientes.getSelectedRow(),3).toString());
         ...
         if (f.getComponent() == jtNombreCliente && (getDialogoListaValores() == null || !getDialogoListaValores().isVisible()) && jtNombreCliente.isFocusable() && mostrarListaAutomatica ) {
             ...
             listaValor.mostrarListaValores();
				 ...
				 if (f.getComponent() != jtNombreCliente  && getDialogoListaValores() != null && getDialogoListaValores().isVisible()) { //Se oculta el scroll de la lista de valores
				   ...
				   if (f.getComponent() == tablaVentasClientes && !jtNombreCliente.getText().isEmpty())

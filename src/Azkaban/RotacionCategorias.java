...
final public class RotacionCategorias extends CrearJFrame implements ActionListener, FocusListener {
   ...
   //Columnas y filas estaticas 
    private Object [] nombresColumnas = {"Código","Categoria","Cantidad","Total"};
    ...
    //** Constructor General 
    public RotacionCategorias(ConectarMySQL p_conectarMySQL,JFrame p_frame) {

      super("Rotación de Categorias","Toolbar",p_frame);
      ...
      jpVentas = getJPanel("Categorias",60, 130, 700, 380,14);
  ...
  //*****************************Metodo traerInformacion() ******************************************
    ...
    final private boolean traerInformacion() { 
        ...
        if (jcPeriodos.getSelectedIndex() == 0)
            ...
            sentenciaSQL    =   "Select  C.IdCategoria, C.Categoria,Sum(V1.Cantidad),Sum(V1.subtotal) "+
                                "From  VentasEncabezado V,VentasDetalle V1, Productos P,Categorias C "+ 
          ...
          if (jcPeriodos.getSelectedIndex() == 1)
	           ...
	           sentenciaSQL    =   "Select C.IdCategoria, C.Categoria,Sum(V1.Cantidad),Sum(V1.subtotal) "+
	                                "From  VentasEncabezado V,VentasDetalle V1, Productos P,Categorias C "+ 
	                                "Where V.NumeroVenta = V1.NumeroVenta and V.estado ='G' and V1.IdProducto = P.IdProducto "+
	                                "      and P.IdCategoria = C.IdCategoria and Substr(V.Fecha,1,10) = '" + getObtenerFecha(conectarMySQL) + "' "+
	                                "Group by C.IdCategoria, C.Categoria "+
	                                "Order by 3 "+ orden +
	                                "Limit " + numeroRegistro ; 
		          ...
		          if (jcPeriodos.getSelectedIndex() == 2) {
		              ...
		              String condicion = ""; 
			           ...
			           sentenciaSQL    =    "Select  C.IdCategoria, C.Categoria,Sum(V1.Cantidad),Sum(V1.subtotal) "+
			                                "From  VentasEncabezado V,VentasDetalle V1, Productos P,Categorias C "+ 
			                                "Where V.NumeroVenta = V1.NumeroVenta and V.estado ='G' and V1.IdProducto = P.IdProducto "+
			                                "      and P.IdCategoria = C.IdCategoria and substr(V.Fecha,1,7) = '" + getObtenerFecha(conectarMySQL).substring(0,7) + "' " +
			          ...
			          if (jcPeriodos.getSelectedIndex() == 3) 
				          ...
				          if (jcPeriodos.getSelectedIndex() == 4) {
					           ...
					           sentenciaSQL    =    "Select  C.IdCategoria, C.Categoria,Sum(V1.Cantidad),Sum(V1.subtotal) "+
					                                "From  VentasEncabezado V,VentasDetalle V1, Productos P,Categorias C "+  
					                                "Where V.NumeroVenta = V1.NumeroVenta and V.estado ='G' and V1.IdProducto = P.IdProducto "+
					                                "      and P.IdCategoria = C.IdCategoria   and substr(V.Fecha,1,7) between " + condicion +
													" Group by C.IdCategoria, C.Categoria "+
					                                "Order by 3 "+ orden +
					                                "Limit " + numeroRegistro ;                        
